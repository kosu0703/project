		...
		<form action="">
			<table class="write_table">
				...
				<tr>
					...
					<td><input type="text" name="qna_subject" required/></td>
				</tr>
				<tr></tr>
				<tr>
					<td class="write_table_subject">내용</td>
					<td><textarea name="" id="" cols="100" rows="20" required></textarea>
					</td>
				</tr>
				<tr>
			...
			<div class="write_btn">
				<input type="button" value="등록" onclick="qna_write_go(this.form)" /> <input
					type="reset" value="취소" />
			</div>
		</form>
		<%-- 푸터 위치 --%>
